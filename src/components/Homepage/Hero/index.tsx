          ...
          <div className="flex flex-col items-center md:flex-row justify-center gap-y-4 text-white">
            <div className="flex flex-col flex-1 items-center gap-6">
              ...
              >
                ...
                urgent personal needs with quick cash loans in less than 5
                minutes without collateral with 24/7 support.
              </motion.p>
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full flex justify-center md:justify-start items-center md:items-start"
              >
